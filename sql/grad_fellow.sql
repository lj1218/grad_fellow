...
CREATE TABLE `user_info` (
  ...
  `tobe_contacted` tinyint(1) NOT NULL,
  `skills_have` text NOT NULL,
  `skills_learned` text NOT NULL,
  `skills_recommend` text NOT NULL,
  `skills_roles_in_company` text NOT NULL,
  `skills_tasks_auto` text NOT NULL,
  `skills_tasks_collab` text NOT NULL,
  `cc_competitiveness` text NOT NULL,
  `cc_desc_by_colleagues` text NOT NULL,
  `cc_working_approach` text NOT NULL,
  `cc_relationship_with_colleague` text NOT NULL,
  `cc_relationship_with_mgr` text NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`),
